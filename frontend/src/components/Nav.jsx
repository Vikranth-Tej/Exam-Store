...
const Nav = () => {
  return (
    <nav className="w-full h-20 flex items-center justify-between px-5 fixed top-0 z-20 bg-[#459ad2]">
      ...
      <ul className="hidden sm:flex items-center justify-center gap-5 text-black list-none text-lg pr-2">
        <li className="cursor-pointer hover:text-cyan-300 hover:border-b-2 border-white">
          Home
        </li>
        <li className="cursor-pointer hover:text-cyan-300 hover:border-b-2 border-white">
          About
